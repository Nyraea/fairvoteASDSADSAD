    ...
    <table class="table mt-3">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('candidates.show', $candidate->candidate_id) }}" class="btn btn-info">View</a>
                    <a href="{{ route('candidates.edit', $candidate->candidate_id) }}" class="btn btn-warning">Edit</a>
