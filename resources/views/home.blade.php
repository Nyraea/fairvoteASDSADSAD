    ...
    <div class="d-flex justify-content-center mt-4">
        ...
        @auth
            @if(Auth::user()->role === 'admin')
                <a href="{{ route('admin.admin') }}" class="btn btn-warning mx-2">Admin Dashboard</a>
            @elseif(Auth::user()->role === 'organizer')
                <a href="{{ route('organizer.organizer') }}" class="btn btn-warning mx-2">Organizer Dashboard</a>
            @endif
        @endauth
    </div>
</div>
